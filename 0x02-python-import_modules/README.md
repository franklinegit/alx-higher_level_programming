...
In a nutshell…
Auto QA review: 68.0/85 mandatory & 27.0/58 optional
Altogether:  117.24%
Mandatory: 80.0%
Optional: 46.55%
Calculation:  80.0% + (80.0% * 46.55%)  == 117.24%
Resources
Read or watch:
...
mandatory
Score: 100.0% (Checks completed: 100.0%)
Write a program that prints all the names defined by the compiled module hidden_4.pyc (please download it locally). (https://github.com/alx-tools/0x02.py/raw/master/hidden_4.pyc)
